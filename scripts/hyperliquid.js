...
const fetchAndStoreHyperliquidData = async (blockTimestamp) => {
    try {
        ...
        await db.promise("INSERT INTO hyperliquid(eth_funding_rate, btc_funding_rate, timestamp) VALUES ($1,$2,$3)", [Number(ethFundingRate).toFixed(10), Number(btcFundingRate).toFixed(10), blockTimestamp]);
    } catch (err) {
